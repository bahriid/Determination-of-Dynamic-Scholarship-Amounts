...
@section('content')
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="rumahNjop" placeholder="Harga NJOP Rumah" name="penghasilanOrangtua" value="{{ old('penghasilanOrangtua') }}">
    </div>
  </div>
  <div class="form-group">
    <label for="itemName" class="col-sm-2 control-label">Kondisi Rumah</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="rumahKondisi" placeholder="Kondisi Rumah" name="nilaiAkademik" value="{{ old('nilaiAkademik') }}">
    </div>
  </div>
  <div class="form-group">
