...
#map-canvas {
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="rumahUsia" name="usiaRumah" value="{{ $rumah->poin_sertifikat }}" readonly="readonly">
    </div>
  </div>
  {{-- <div class="form-group">
  ...
  {{-- <div class="form-group">
    ...
    <div class="form-group">
    <label for="hasilAkhir" class="col-sm-2 control-label">Jumlah Beasiswa</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="hasilAkhir" value="{{ currency($hasilAkhir) }}" readonly="readonly">
    </div>
  </div>
  <div class="form-group">
      <label for="calcFuzzy" class="col-sm-2 control-label">Kalkulasi Fuzzy</label>
      <div class="col-sm-10">
